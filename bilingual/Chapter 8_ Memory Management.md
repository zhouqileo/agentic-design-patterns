...
PROJECT_ID = "your-gcp-project-id" # Replace with your GCP project ID / 替换为您的 GCP 项目 ID
LOCATION = "us-central1" # Replace with your desired GCP location / 替换为您想要的 GCP 位置
...
REASONING_ENGINE_APP_NAME = "projects/your-gcp-project-id/locations/us-central1/reasoningEngines/your-engine-id" # Replace with your Reasoning Engine resource name / 替换为您的 Reasoning Engine 资源名称
...
RAG_CORPUS_RESOURCE_NAME = "projects/your-gcp-project-id/locations/us-central1/ragCorpora/your-corpus-id" # Replace with your Corpus resource name / 替换为您的 Corpus 资源名称

## Optional configuration for retrieval behavior
## 检索行为的可选配置
SIMILARITY_TOP_K = 5 # Number of top results to retrieve / 要检索的顶部结果数
VECTOR_DISTANCE_THRESHOLD = 0.7 # Threshold for vector similarity / 向量相似度阈值
...
3. Vertex AI Agent Engine Memory Bank, [https://cloud.google.com/blog/products/ai-machine-learning/vertex-ai-memory-bank-in-public-preview](https://cloud.cloud.google.com/blog/products/ai-machine-learning/vertex-ai-memory-bank-in-public-preview)
